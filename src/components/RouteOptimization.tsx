...
import RouteOptimizationPanel from './route-optimization/RouteOptimizationPanel';
    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        <TabsList className="mb-4">
          ...
          <TabsTrigger value="wizard">Route Wizard</TabsTrigger>
        ...
        <TabsContent value="wizard" className="animate-fade-in">
